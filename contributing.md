# Contributing to event-callback

First and foremost, thank you! We appreciate that you want to contribute to event-callback, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for event-callback**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for event-callback:

- star the [project](https://github.com/jamen/event-callback)
- tweet your support for event-callback
...
- **version**: please note the version of event-callback are you using
...
[so]: http://stackoverflow.com/questions/tagged/event-callback